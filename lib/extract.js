...
- one or more pages of a handwritten merchant application (the Citizens/Priority form, the FD North/Synovus form — same Priority layout, Synovus Bank in the footer — or the Merrick form),
- a voided check,
...
export function normalizeRecord(raw = {}) {
  ...
  const out = {
    appType: ["citizens", "merrick", "fd_north"].includes(r.appType) ? r.appType : "unknown",
