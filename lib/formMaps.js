...
const citizens = {
  ...
  sign: [
    { page: 2, x: 66, y: 257, maxW: 128, maxH: 12 },
    { page: 2, x: 66, y: 137, maxW: 128, maxH: 12 },
    { page: 3, x: 154, y: 61, maxW: 195, maxH: 15 },
  ],
};
...
const merrick = {
  ...
  sign: [
    { page: 2, x: 66, y: 542, maxW: 165, maxH: 13 },
    { page: 2, x: 68, y: 244, maxW: 160, maxH: 13 },
  ],
};
...
const purchase_order = {
  ...
  sign: [
    { page: 1, x: 168, y: 101, maxW: 135, maxH: 14 },
  ],
};
...
const clover_addendum = {
  ...
  sign: [
    { page: 1, x: 92, y: 173, maxW: 180, maxH: 15 },
  ],
};
