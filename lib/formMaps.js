...
const merrick = {
  ...
  check: [
    ...
    { on: (r) => /corp/.test(orgType(r)) && !/ll[cp]|limited liab/.test(orgType(r)), page: 1, text: "Corporation", region: { yMin: 589, yMax: 596 }, center: true, absX: 139.9 },
...
export const FORM_MAPS = { citizens, merrick, coversheet, purchase_order, clover_addendum, bank_change, fd_north };
