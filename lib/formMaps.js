...
const citizens = {
  text: [
    ...
    { get: sigTitle, page: 2, text: "Title", region: { yMin: 255, yMax: 263, xMax: 280 }, place: "right", dx: 6, maxWidth: 95 },
    { get: sigDate, page: 2, text: "Date:", region: { yMin: 232, yMax: 240, xMax: 280 }, place: "right", dx: 6, maxWidth: 95 },
    ...
    { get: sigTitle, page: 2, text: "Title", region: { yMin: 139, yMax: 147, xMax: 280 }, place: "right", dx: 6, maxWidth: 95 },
    { get: sigDate, page: 2, text: "Date:", region: { yMin: 115, yMax: 123, xMax: 280 }, place: "right", dx: 6, maxWidth: 95 },
    ...
    { get: sigTitle, page: 3, text: "Title:", place: "right", dx: 6, maxWidth: 110 },
  ...
  check: [
    ...
    { on: (r) => /partner/.test(orgType(r)) && !/ll[cp]/.test(orgType(r)), page: 1, text: "Partnership", region: { yMin: 588, yMax: 595 }, center: true, absX: 438 },
    { on: (r) => /ll[cp]/.test(orgType(r)), page: 1, text: "LLC/LLP", region: { yMin: 588, yMax: 595 }, center: true, absX: 497.8 },
    { on: (r) => /corp/.test(orgType(r)) && !/s[-\s]?corp/.test(orgType(r)) && !/ll[cp]/.test(orgType(r)), page: 1, text: "C CORP", region: { yMin: 588, yMax: 595 }, center: true, absX: 547.8 },
    { on: (r) => /s[-\s]?corp/.test(orgType(r)), page: 1, text: "S CORP", region: { yMin: 579, yMax: 586 }, center: true, absX: 315.2 },
    { on: (r) => /govern|gov't|gov\b/.test(orgType(r)), page: 1, text: "Local/State/Federal", region: { yMin: 579, yMax: 586 }, center: true, absX: 358.7 },
...
const merrick = {
  ...
  check: [
    ...
    { on: (r) => /partner/.test(orgType(r)) && !/ll[cp]/.test(orgType(r)), page: 1, text: "Partnership", region: { yMin: 589, yMax: 596 }, center: true, absX: 96.6 },
    { on: (r) => /corp/.test(orgType(r)) && !/ll[cp]/.test(orgType(r)), page: 1, text: "Corporation", region: { yMin: 589, yMax: 596 }, center: true, absX: 139.9 },
    { on: (r) => /ll[cp]/.test(orgType(r)), page: 1, text: "LLC", region: { yMin: 589, yMax: 596 }, center: true, absX: 184.8 },
    { on: (r) => /non.?profit|501/.test(orgType(r)), page: 1, text: "Non-Profit", region: { yMin: 589, yMax: 596 }, center: true, absX: 206.7 },
    { on: (r) => /govern/.test(orgType(r)), page: 1, text: "Government", region: { yMin: 589, yMax: 596 }, center: true, absX: 302 },
    // Seasonal merchant — mark "Yes" only when flagged (single review checkbox).
...
// float noise (e.g. 850 + 0.1 + 0.2 -> "850.3", not "850.3000000000001").
...
const bank_change = {
  ...
  check: [
    ...
    { on: (r) => bc(r).docBankStatement, page: 1, text: "BANK STATEMENT", region: { yMin: 398, yMax: 406 }, center: true, absX: 391, absY: 404 },
  ],
...
export const FORM_MAPS = { citizens, merrick, coversheet, purchase_order, clover_addendum, bank_change };
