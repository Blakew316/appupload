...
const purchase_order = {
  text: [
    ...
    { get: (r) => po(r).team || cs(r).teamColor, page: 1, text: "Team:", place: "right", dx: 4, maxWidth: 120 },
    ...
    ...ROWY.flatMap((y, i) => [
      { get: (r) => (eqHas(r, i) ? eqName(r, i) : ""), page: 1, text: "Equipment Type", absX: 24, absY: y, place: "right", maxWidth: 210 },
  ...
  check: [
    { on: (r) => po(r).payPlan === "3pay", page: 1, text: "3 Pay*", dx: -12 },
    { on: (r) => po(r).payPlan === "4pay", page: 1, text: "4 Pay*", dx: -12 },
    { on: (r) => (po(r).shipTo || "dba") === "dba", page: 1, text: "Merchant DBA", region: { yMin: 391, yMax: 403 }, dx: -12 },
    { on: (r) => po(r).shipTo === "rep", page: 1, text: "Sales Rep", region: { yMin: 391, yMax: 403 }, dx: -12 },
    { on: (r) => po(r).shipTo === "other", page: 1, text: "Other", region: { yMin: 391, yMax: 403 }, dx: -12 },
    { on: (r) => (po(r).shippingMethod || "ground") === "ground", page: 1, text: "Ground:", dx: -12 },
    { on: (r) => po(r).shippingMethod === "2day", page: 1, text: "2 Day:", dx: -12 },
    { on: (r) => po(r).shippingMethod === "overnight", page: 1, text: "Overnight:", dx: -12 },
    { on: (r) => po(r).billingType === "cc", page: 1, text: "Credit Card", dx: -12 },
    { on: (r) => (po(r).billingType || "ach") === "ach", page: 1, text: "ACH", region: { yMin: 219, yMax: 227 }, dx: -12 },
  ],
};
