...
const coversheet = {
  // White-out the pre-printed "TSYS (Synovus Bank)" under Requested Platform so we
  // can relabel that option "Merrick" (see the text spec below).
  cover: [{ page: 1, x: 432, y: 604, w: 78, h: 14 }],
  text: [
    // Requested Platform: relabel the top option from "TSYS (Synovus Bank)" to "Merrick".
    { get: () => "Merrick", page: 1, text: "TSYS", place: "right", absX: 435, absY: 609, size: 11, bold: true, color: "black" },
    // Header
