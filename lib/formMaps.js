...
const citizens = {
  ...
  check: [
    ...
    { on: (r) => /ll[cp]|limited liab/.test(orgType(r)), page: 1, text: "LLC/LLP", region: { yMin: 588, yMax: 595 }, center: true, absX: 497.8 },
    ...
    { on: (r) => /s[-\s]?corp/.test(orgType(r)), page: 1, text: "S CORP", region: { yMin: 579, yMax: 586 }, center: true, absX: 315.2 },
    { on: (r) => /govern|gov't|gov\b|municip/.test(orgType(r)), page: 1, text: "Local/State/Federal", region: { yMin: 579, yMax: 586 }, center: true, absX: 358.7 },
...
const bank_change = {
  ...
  check: [
    ...
    { on: (r) => bc(r).addrMatchesFile, page: 1, text: "Matches what is on file", center: true, absX: 207, absY: 612 },
    { on: (r) => bc(r).addrChangeLegal, page: 1, text: "Legal Entity address", center: true, absX: 364, absY: 612 },
    { on: (r) => bc(r).addrChangeDba, page: 1, text: "address on file, check here", center: true, absX: 529, absY: 612 },
    ...
    { on: (r) => bc(r).docVoidedCheck, page: 1, text: "VOIDED CHECK", center: true, absX: 85, absY: 404 },
...
const BIZ_RULES = [
  ...
  [/internet|e-?comm|online|web/, "Internet", 222.5, 282.6],
  [/government|municip/, "Government", 289.5, 282.6],
  [/lodging|hotel|motel/, "Lodging", 352.6, 282.6],
  ...
  [/health|medical|clinic|dental/, "Healthcare", 224, 265.6],
  [/education|school|tutor/, "Education", 293.5, 265.6],
  [/qsr|quick serve|fast food/, "QSR", 353.4, 265.6],
  [/charity|non.?profit/, "Charity/Non Profit", 399.8, 265.6],
  [/b2b|business to business|wholesale/, "B2B", 494.1, 265.6],
];
...
const pbt = {
  ...
  check: [
    ...
    { on: (r) => /sole|individual|propriet/.test(orgType(r)), page: 1, text: "Sole Prop", center: true, absX: 39.5, dy: 0 },
    { on: (r) => /partner/.test(orgType(r)) && !/ll[cp]|limited liab/.test(orgType(r)), page: 1, text: "Partnership", region: { yMin: 508, yMax: 516 }, center: true, absX: 104.5 },
    ...
    { on: (r) => /govern|gov't|gov\b|municip/.test(orgType(r)), page: 1, text: "Govt.", region: { yMin: 508, yMax: 516 }, center: true, absX: 350 },
    { on: (r) => /non.?profit|501/.test(orgType(r)), page: 1, text: "501c/Tax Ex.", center: true, absX: 450.5 },
    /* p1 seasonal + business type */
    { on: (r) => r.transaction.seasonal === true, page: 1, text: "Seasonal Merchant?", center: true, absX: 128, absY: 190.3 },
    /* p1 business-type row is generated below via BIZ_RULES */
    /* p2 card types (boxes left of labels, raised ~3pt) */
    { on: (r) => r.serviceAcceptance.cardVisaCredit, page: 2, text: "Visa Credit", center: true, absX: 35, dy: 3 },
    { on: (r) => r.serviceAcceptance.cardVisaDebit, page: 2, text: "Visa Non-PIN Debit", center: true, absX: 94, dy: 3 },
    { on: (r) => r.serviceAcceptance.cardMcCredit, page: 2, text: "MasterCard Credit", center: true, absX: 182.5, dy: 3 },
    { on: (r) => r.serviceAcceptance.cardMcDebit, page: 2, text: "MasterCard Non-PIN Debit", center: true, absX: 268, dy: 3 },
    { on: (r) => r.serviceAcceptance.cardDiscover, page: 2, text: "Discover Network", region: { yMin: 723, yMax: 731 }, center: true, absX: 364.5, dy: 3 },
    { on: (r) => r.serviceAcceptance.cardAmex, page: 2, text: "American Express", region: { yMin: 723, yMax: 731 }, center: true, absX: 442, dy: 3 },
    { on: (r) => r.serviceAcceptance.cardPin, page: 2, text: "PIN Debit", region: { yMin: 723, yMax: 731 }, center: true, absX: 540.5, dy: 3 },
    /* p2 discount plan + payment method + assessments */
    { on: (r) => r.serviceAcceptance.discountPlan === "flat", page: 2, text: "Flat Rate", region: { yMin: 695, yMax: 704 }, center: true, absX: 186, dy: 1 },
    { on: (r) => r.serviceAcceptance.discountPlan === "passthrough", page: 2, text: "Pass Through I/C", region: { yMin: 677, yMax: 686 }, center: true, absX: 79, dy: 1 },
    ...
    { on: (r) => r.serviceAcceptance.cardEbt, page: 3, text: "Accept EBT", region: { yMin: 740, yMax: 748 }, center: true, absX: 142.6, absY: 743.8 },
    { on: (r) => cs(r).enWex, page: 3, text: "Order Wright Express", center: true, absX: 319.8, absY: 727.8 },
    { on: (r) => cs(r).vasCheckServices, page: 3, text: "ACH/Check Services", center: true, absX: 530.4, absY: 743.8 },
    { on: (r) => cs(r).vasGiftCards, page: 3, text: "Gift Card", center: true, absX: 529.6, absY: 719.8 },
    { on: (r) => cs(r).fbAppType === "retail", page: 3, text: "Application Type", center: true, absX: 153, absY: 660.2 },
    { on: (r) => cs(r).fbAppType === "moto", page: 3, text: "Application Type", center: true, absX: 265.5, absY: 660.2 },
    { on: (r) => cs(r).fbAppType === "restaurant", page: 3, text: "Application Type", center: true, absX: 349, absY: 660.2 },
    ...
    { on: (r) => cs(r).fbConnection === "ethernet", page: 3, text: "IP Connection?", center: true, absX: 110.2, absY: 605.3 },
    { on: (r) => cs(r).fbConnection === "wifi" || cs(r).fbConnection === "wireless", page: 3, text: "Wireless?", center: true, absX: 110.6, absY: 587.4 },
    ...
    { on: (r) => Boolean(raw(own(r, 0).dlNumber)), page: 6, text: "Beneficial", occ: 0, region: { yMin: 280, yMax: 545, xMax: 40 }, center: true, absX: 72.4, absY: 475 },
    ...
    { on: (r) => Boolean(raw(own(r, 1).dlNumber)), page: 6, text: "Beneficial", occ: 1, region: { yMin: 280, yMax: 545, xMax: 40 }, center: true, absX: 72.4, absY: 393.4 },
  ],
  sign: [
...
pbt.check.push({ on: (r) => Boolean(bizType(r)) && !bizMatched(r), page: 1, text: "Business Type:", center: true, absX: 533.5, absY: 265.6, _biz: "Other" });
// PB&T p3 equipment rows: type boxes (from the pricing category), deployment boxes.
{
  ...
  ROWS.forEach((ry, i) => {
    ...
    pbt.check.push(
      ...
      { on: (r) => /printer/i.test(m(r)) || /printer/i.test(raw(eqItem(r, i).type)), page: 3, text: "Printer", occ: 0, region: { yMin: ry - 5, yMax: ry + 5 }, center: true, absX: 165, absY: ry },
      { on: (r) => eqHas(r, i) && eqItem(r, i).acquisition === "existing", page: 3, text: "Existing", occ: 0, region: { yMin: ry - 5, yMax: ry + 5 }, center: true, absX: 399.5, absY: ry },
...
const crf = {
  ...
  check: [
    ...
    { on: (r) => Boolean(raw(crfR(r).dbaAddress)), page: 1, text: "DBA ADDRESS:", center: true, absX: 69.5, dy: 1.5 },
    ...
    { on: (r) => Boolean(crfR(r).amexOptBluePlan) || Boolean(raw(crfR(r).amexOptBlueRate)), page: 1, text: "AMEX OPT BLUE", center: true, absX: 69.5, dy: 1.5 },
    ...
    { on: (r) => Boolean(raw(crfR(r).amexDirectSe)), page: 1, text: "AMEX DIRECT SE#", center: true, absX: 69.5, dy: 1.5 },
    ...
    { on: (r) => Boolean(raw(crfR(r).ebtFns)) || Boolean(raw(crfR(r).ebtFee)), page: 1, text: "EBT", exact: true, center: true, absX: 69.5, dy: 1.5 },
    ...
    { on: (r) => Boolean(raw(crfR(r).other1)) || Boolean(raw(crfR(r).other1Rate)), page: 1, text: "OTHER:", occ: 0, region: { yMin: 204, yMax: 228 }, center: true, absX: 69.5, dy: 1.5 },
    { on: (r) => Boolean(raw(crfR(r).other2)) || Boolean(raw(crfR(r).other2Rate)), page: 1, text: "OTHER:", occ: 1, region: { yMin: 204, yMax: 228 }, center: true, absX: 69.5, dy: 1.5 },
  ],
  sign: [{ page: 1, x: 172, y: 83, maxW: 165, maxH: 20 }],
};

export const FORM_MAPS = { citizens, merrick, coversheet, purchase_order, clover_addendum, bank_change, fd_north, pbt, crf };
